...
import type { PopularMedia } from "@/types/media";
    ...
    <div className={clsx("h-92 relative")}>
      <div className="relative h-72 overflow-hidden">
          ...
          <>
            ...
            {prevIndex !== null && (
              ...
              >
                <img
                  ...
                  alt={
                    media[prevIndex]?.title?.english ?? "Previous anime banner"
                  }
                  draggable="false"
            ...
            >
              <img
                ...
                alt={media[index]?.title?.english ?? "Current anime banner"}
                draggable="false"
                className="w-full h-full object-cover select-none"
              />
            </div>
        ...
        {isTabletAndUp && (
          <LgScreenLayout
            title={
              (media[index]?.title?.english || media[index]?.title?.romaji) ??
              "No title found"
            }
            desc={media[index]?.description ?? "No description found"}
