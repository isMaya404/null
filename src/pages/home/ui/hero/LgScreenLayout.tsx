...
import { collapseBrTags } from "@/lib/sanitizeHTML";
...
const LgScreenLayout = ({
  ...
  const isBookmarked = useHeroStore((s) => s.isBookmarked(`bookmark-${index}`));
        ...
        <div className="text-light">
          ...
          {desktop && (
            <div
              ...
              // sanitizes br tags because anilist returns too
              // many br for this specific layout usecase
              dangerouslySetInnerHTML={{ __html: collapseBrTags(desc) }}
            />
          )}
